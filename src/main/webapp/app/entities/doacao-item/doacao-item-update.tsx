  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...
          cadastroDoacao: doacaoItemEntity?.cadastroDoacao?.id,
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="biomobv30App.doacaoItem.home.createOrEditLabel" data-cy="DoacaoItemCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                id="doacao-item-cadastroDoacao"
                name="cadastroDoacao"
                data-cy="cadastroDoacao"
                label="Cadastro Doacao"
                type="select"
              >
                <option value="" key="0" />
                {cadastroDoacaos
