...
public class SolicitacaoItem implements Serializable {
    ...
    @ManyToOne
    @JsonIgnoreProperties(value = { "user", "descricaos" }, allowSetters = true)
    private CadastroSolicitacao cadastroSolicitacao;

    @JsonIgnoreProperties(value = { "doacaoItem", "user", "solicitacaoItem" }, allowSetters = true)
    ...
    public CadastroSolicitacao getCadastroSolicitacao() {
        return this.cadastroSolicitacao;
    }

    public void setCadastroSolicitacao(CadastroSolicitacao cadastroSolicitacao) {
        this.cadastroSolicitacao = cadastroSolicitacao;
    }

    public SolicitacaoItem cadastroSolicitacao(CadastroSolicitacao cadastroSolicitacao) {
        this.setCadastroSolicitacao(cadastroSolicitacao);
        return this;
    }
