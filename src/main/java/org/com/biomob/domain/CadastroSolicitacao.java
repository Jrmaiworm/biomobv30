...
public class CadastroSolicitacao implements Serializable {
    ...
    @OneToMany(mappedBy = "cadastroSolicitacao")
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    @JsonIgnoreProperties(value = { "descricao", "cadastroSolicitacao", "acao" }, allowSetters = true)
    private Set<SolicitacaoItem> descricaos = new HashSet<>();
    ...
    public CadastroSolicitacao user(User user) {
        this.setUser(user);
        return this;
    }

    public Set<SolicitacaoItem> getDescricaos() {
        return this.descricaos;
    }

    public void setDescricaos(Set<SolicitacaoItem> solicitacaoItems) {
        if (this.descricaos != null) {
            this.descricaos.forEach(i -> i.setCadastroSolicitacao(null));
        }
        if (solicitacaoItems != null) {
            solicitacaoItems.forEach(i -> i.setCadastroSolicitacao(this));
        }
        this.descricaos = solicitacaoItems;
    }

    public CadastroSolicitacao descricaos(Set<SolicitacaoItem> solicitacaoItems) {
        this.setDescricaos(solicitacaoItems);
        return this;
    }

    public CadastroSolicitacao addDescricao(SolicitacaoItem solicitacaoItem) {
        this.descricaos.add(solicitacaoItem);
        solicitacaoItem.setCadastroSolicitacao(this);
        return this;
    }

    public CadastroSolicitacao removeDescricao(SolicitacaoItem solicitacaoItem) {
        this.descricaos.remove(solicitacaoItem);
        solicitacaoItem.setCadastroSolicitacao(null);
        return this;
    }
